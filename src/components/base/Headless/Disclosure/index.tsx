  ...
  return (
    <HeadlessDisclosure
      ...
      className={twMerge([
        ...
        "[&:not(:last-child)]:dark:border-darkmode-400 [&:not(:last-child)]:border-b [&:not(:last-child)]:border-slate-200/60",
        group.variant == "boxed" &&
          "dark:border-darkmode-400 mt-3 border border-slate-200/60 p-4 first:mt-0 last:mb-0",
        className,
      ])}
      {...props}
    >
  ...
  return (
    ...
    >
      <HeadlessDisclosure.Panel
        as="div"
        className={twMerge([
          "mt-3 leading-relaxed text-slate-700 dark:text-slate-400",
          className,
        ])}
        {...props}
      >
