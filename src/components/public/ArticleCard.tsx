          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-gray-600 mb-2">
              ...
              {article.coAuthors.length > 0 && (
                <span className="text-gray-500"> et {article.coAuthors.length} co-auteur{article.coAuthors.length > 1 ? 's' : ''}</span>
              )}
            </p>
                ...
                <>
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500">
                      {article.coAuthors.slice(0, 2).map(ca => ca.author.firstName + ' ' + ca.author.lastName).join(', ')}
